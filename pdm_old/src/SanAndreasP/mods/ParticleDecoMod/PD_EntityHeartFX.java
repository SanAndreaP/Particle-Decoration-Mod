...
public class PD_EntityHeartFX extends PD_EntityParticlesFX
{

    public PD_EntityHeartFX(World world, double d, double d1, double d2, double d3, double d4, double d5, boolean b, boolean b1, int i, int j)
    {
