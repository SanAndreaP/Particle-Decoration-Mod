...
public class PD_EntityPotionFX extends PD_EntityParticlesFX
{

    public PD_EntityPotionFX(World world, double d, double d1, double d2, double d3, double d4, double d5, float f, float f1, float f2, boolean b, boolean b1, int i, int j)
    {
...
//        particleMaxAge = 40;
    ...
    public void onUpdate()
    {
        ...
        setParticleTextureIndex(135 - ((particleAge * 8) / particleMaxAge));
